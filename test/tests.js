...
describe('Cross Origin Requests', function() {
  ...
  //   //expect(result).to.have.deep.property("header[access-control-allow-origin]");
  //   console.log(header);
  //   console.log("haha");
  //   haha = header['access-control-allow-origin'];
  //   return assert(result, haha).to.equal('*');
  // });
...
function assertnow(result, prop) {
  return expect(result).to.have.deep.property(prop)
}
